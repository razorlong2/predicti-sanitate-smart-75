...
import { ChevronLeft, ChevronRight, FileText, Brain, Database, Activity } from "lucide-react";
...
const slides = [
  ...
  },
  {
    ...
    icon: Activity,
    component: DataFlowSlide,
  },
  {
    id: 3,
    title: "Modelul ML",
    icon: Brain,
    component: MLModelSlide,
  },
  {
    id: 4,
    title: "Rezultate & Predicții",
    icon: Activity,
